    ...
    return (
        <div className="underheader mw-100 row">
            ...
            <div className="col-10 col-md-4 h-100 d-flex align-items-center">
                <input class="form-control form-control-sm" type="text" defaultValue={link} value={link} onChange={(e) => dispatch({ type: "UPDATE_QR", payload: { data: e.target.value } })} />
